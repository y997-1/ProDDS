...
from GCNmodel import GCNEncoder, Cell2Vec
...
if __name__ == '__main__':
    ...
    np.save(os.path.join(mdl_dir, 'GCNembeddings.npy'), embeddings)
    logging.info("Save {}".format(os.path.join(mdl_dir, 'GCNembeddings.npy')))
