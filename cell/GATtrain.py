...
from GATmodel import GATEncoder, Cell2Vec
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_dim', type=int, default=128,
                        help="dim of hidden space for GAT layer")
    ...
    encoder = GATEncoder(node_features.shape[1], hidden_dim, activation, k=num_layers).to(device)
    ...
    np.save(os.path.join(mdl_dir, 'GATembeddings.npy'), embeddings)
    logging.info("Save {}".format(os.path.join(mdl_dir, 'GATembeddings.npy')))
