...
from GraphSAGEmodel import GraphSAGEEncoder, Cell2Vec
...
if __name__ == '__main__':
    ...
    encoder = GraphSAGEEncoder(node_features.shape[1], hidden_dim, activation, k=num_layers).to(device)
    ...
    np.save(os.path.join(mdl_dir, 'GraphSAGEembeddings.npy'), embeddings)
    logging.info("Save {}".format(os.path.join(mdl_dir, 'GraphSAGEembeddings.npy')))
